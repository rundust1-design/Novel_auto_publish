...
echo ===========================================
echo.
tasklist /FI "IMAGENAME eq FanqiePublisher_PRO.exe" | find /I "FanqiePublisher_PRO.exe" > nul
if not errorlevel 1 (
    echo 检测到 FanqiePublisher_PRO.exe 正在运行。
    echo 请先关闭所有番茄发文助手窗口，再重新双击本脚本打包。
