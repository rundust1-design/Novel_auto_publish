...
def login():
    ...
    with sync_playwright() as p:
        ...
        browser = launch_anti_detect_browser(p, headless=False)
        ...
        print("正在打开咪咕文学作家后台...")
        try:
            page.goto("https://www.cmread.com/wenxuenew/", timeout=60000)
        except Exception as e:
            print(f"打开网页遇到问题，请检查网络: {e}")
            print("浏览器仍然保持打开，您可以手动在地址栏输入 https://www.cmread.com/wenxuenew/")

        print("\n" + "="*50)
        print("请在弹出的浏览器窗口中登录您的咪咕文学作家账号（可以密码、验证码或扫码登录）。")
